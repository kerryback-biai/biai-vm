...
*[Revenue by Division bar chart: grouped bars showing Q3 (light blue) vs Q4 (dark blue) for each division]*
...
*Note: Headcount excludes 71 Corporate employees who do not generate direct division revenue.*
...
- **Worst supplier:** Huang-Martinez (quality score 2.8, avg 8.3 days late, 12 POs)
- **Trend:** Deteriorating vs. Q3 — requires supplier review

### Energy (Oracle SCM)
- **Late delivery rate:** 11.9% (5 of 42 shipments late in Q4)
- **Worst supplier:** Gonzalez & Sons (rating 2.9, avg 7.1 days late, 8 POs)
...
Energy has the lowest customer satisfaction, likely correlated with supply chain delays.
...
- Industrial supplier quality deteriorating — Huang-Martinez should be on a performance improvement plan
